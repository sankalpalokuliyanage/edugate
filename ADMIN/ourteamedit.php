...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addMember'])) {
    ...
    $sql = "INSERT INTO members (name, position, description, picture) VALUES ('$name', '$position', '$description', '$id_picture')";

    if ($conn->query($sql) === TRUE) {
        $_SESSION['success'] = "New team member added successfully!";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="AddAdminPofileLabel">Add Team Member</h5>
